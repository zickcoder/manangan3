...
const DEFAULT_BURIALS = [
  {
    ...
    contact_person: 'Maria Dela Cruz (Daughter)',
    contact_phone: '+63 917 222 8891',
    status: 'Completed',
...
const DEFAULT_UTILITIES = [
  {
    ...
    citizen_phone: '+63 917 111 2233',
    service_type: 'Drainage Clogging',
    location: 'Zone 2, Main Drainage Line',
  ...
  },
  {
    ...
    service_type: 'Water Pipe Leakage',
...
const DEFAULT_ASSETS = [
  {
    ...
    name: 'Isuzu 5000L Water Response Tanker',
    category: 'Heavy Vehicles & Transport',
    serial_no: 'ISZ-WT-88219',
    purchase_date: '2024-02-15',
    purchase_cost: 1500000,
    current_condition: 'Operational',
    assigned_department: 'Disaster Risk Reduction & Management',
  ...
  },
  {
    ...
    name: 'Caterpillar 45kVA Civic Standby Generator',
    ...
    ai_maintenance_alert: 'Battery backup level normal.'
  }
];
...
const DEFAULT_RESERVATIONS = [
  {
    ...
    applicant_name: 'Kapitan Roberto Fernandez',
    applicant_email: 'roberto@barangay178.gov.ph',
    applicant_phone: '+63 917 555 1234',
    purpose: 'Barangay Assembly & Quarterly Public Townhall',
    event_date: '2026-09-05',
    start_time: '08:00 AM',
    end_time: '12:00 PM',
    attendees: 250,
    status: 'Approved',
    remarks: 'Approved by Executive Committee'
  }
];
...
export async function createBurial(payload: any) {
  ...
  if (payload.plot_id) {
    updatePlotStatus(Number(payload.plot_id), 'Occupied');
  }
...
export async function createUtilityRequest(payload: any) {
  ...
  const newReq = {
    ...
    ai_priority_score: payload.urgency === 'High' ? 88 : 65,
    status: 'Pending',
    created_at: new Date().toISOString()
  };
